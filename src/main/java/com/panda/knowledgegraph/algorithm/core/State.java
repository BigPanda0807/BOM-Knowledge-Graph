package com.panda.knowledgegraph.algorithm.core;

import com.panda.knowledgegraph.algorithm.graph.Graph;
import com.panda.knowledgegraph.algorithm.graph.Node;
import com.panda.knowledgegraph.algorithm.graph.Edge;
...
public class State {
     ...
     * Write state to file
     */
    public HashMap<Integer, Integer> writeMapping(PrintWriter writer) {
        HashMap<Integer, Integer> hashMap = new HashMap<>();
        for (int i = 0; i < core_2.length; i++) {
            writer.write("(" + core_2[i] + "-" + i + ") ");
            hashMap.put(core_2[i], i);
        }
        writer.write("\n");
        return hashMap;
    }
